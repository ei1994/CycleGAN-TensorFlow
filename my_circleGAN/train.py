# -*- coding: utf-8 -*-
"""
Created on Wed Aug 23 11:02:43 2017
...
tf.flags.DEFINE_string('X', 'datasets/man2woman/man.tfrecords',
                       'X tfrecords file for training, default: data/tfrecords/apple.tfrecords')
tf.flags.DEFINE_string('Y', 'datasets/man2woman/woman.tfrecords',
