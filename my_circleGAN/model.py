# -*- coding: utf-8 -*-
"""
Created on Wed Aug 23 11:03:33 2017
...
class CycleGAN:
    ...
    def model(self):
            ...
            cycle_loss = self.cycle_consistancy_loss(self.G, self.F, x, y)
    ...
    def optimize(self, G_loss, D_Y_loss, F_loss, D_X_loss):
        ...
        def make_optimizer(loss, variables, name='Adam'):
            ...
            learning_step = (
                    tf.train.AdamOptimizer(learning_rate, beta1=beta1, name=name).minimize(loss, 
    ...
    def cycle_consistancy_loss(self, G, F, x, y):
